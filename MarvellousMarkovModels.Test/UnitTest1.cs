...
public class UnitTest1
{
    ...
    public void Stars()
    {
        var starNames = new List<string>
        {
            ...
            "Tabit", "Talitha", "Tania", "Tarazet", "Tarazed", "Taygeta", "Tegmen", "Tegmine", "Terebellum",
            "Tejat",
            ...
            "Zaniah", "Zaurak", "Zavijava", "Zawiat", "Zedaron", "Zelphah", "Zibal", "Zosma", "Zuben",
            "Zubenelgenubi",
            "Zubeneschamali"
        };
        ...
        for (var i = 0; i < 20; i++) Console.WriteLine("{0},{1}", i, builder._productions.Count(a => a.Value.Count == i));
